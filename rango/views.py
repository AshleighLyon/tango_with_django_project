...
def about(request):
    ...
    context_dict = {'boldmessage':
                    "This tutorial has been put together by Ashleigh"}
...
def show_category(request, category_name_slug):
    ...
    try:
        ...
        # So the .get() method returns one model instance or raises
        # an exception.
        category = Category.objects.get(slug=category_name_slug)

        # Retrieve all of the associated pages.
        # Note that filter() will return a list of page objects
        # or an empty list
